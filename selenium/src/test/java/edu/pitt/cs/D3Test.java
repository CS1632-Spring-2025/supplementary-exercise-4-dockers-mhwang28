  ...
  */
  ...
  public void tEST1LINKS() {
    ...
    }
    {
      ...
      vars.put("hrefVal", attribute);
    }
    assertEquals(vars.get("hrefVal").toString(), "http://localhost:8080/reset");
  }
  @Test
  ...
  public void tEST3CATALOG() {
    ...
    driver.findElement(By.linkText("Catalog")).click();
    {
      ...
      vars.put("cat2Val", attribute);
    }
    assertEquals(vars.get("cat2Val").toString(), "http://localhost:8080/images/cat2.jpg");
  }
  @Test
  public void tEST4LISTING() {
    ...
    js.executeScript("document.cookie = \"1=false\"; document.cookie = \"2=false\"; document.cookie = \"3=false\";");
    driver.findElement(By.linkText("Catalog")).click();
    vars.put("catCount", driver.findElements(By.xpath("//*[@id=\"listing\"]//li")).size());
    assertEquals(vars.get("catCount").toString(), "3");
    assertThat(driver.findElement(By.xpath("//*[@id=\"listing\"]//li[3]")).getText(), is("ID 3. Mistoffelees"));
  }
  @Test
  ...
  public void tEST9FEED() {
    ...
    driver.findElement(By.xpath("//button[text()=\"Feed\"]")).click();
    {
      ...
      wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"feedResult\" and contains(text(),\"Nom, nom, nom.\")]")));
    }
  ...
  public void tEST7RETURN() {
    ...
    assertThat(driver.findElement(By.xpath("//*[@id=\"listing\"]//li[1]")).getText(), is("ID 1. Jennyanydots"));
    assertThat(driver.findElement(By.xpath("//*[@id=\"listing\"]//li[2]")).getText(), is("ID 2. Old Deuteronomy"));
    assertThat(driver.findElement(By.xpath("//*[@id=\"listing\"]//li[3]")).getText(), is("ID 3. Mistoffelees"));
  }
  @Test
  ...
  public void tEST6RENT() {
    ...
    assertThat(driver.findElement(By.xpath("//*[@id=\"listing\"]//li[1]")).getText(), is("Rented out"));
    assertThat(driver.findElement(By.xpath("//*[@id=\"listing\"]//li[2]")).getText(), is("ID 2. Old Deuteronomy"));
    assertThat(driver.findElement(By.xpath("//*[@id=\"listing\"]//li[3]")).getText(), is("ID 3. Mistoffelees"));
  }
  @Test
  ...
  public void dEFECT3FUNGREETACAT() {
    ...
    assertThat(driver.findElement(By.xpath("//*[@id=\"greeting\"]/h4")).getText(), is(""));
  }
  ...
  public void dEFECT2FUNFEED() {
    ...
    js.executeScript("document.cookie = \"1=false\"; document.cookie = \"2=false\"; document.cookie = \"3=false\";");
    driver.findElement(By.linkText("Feed-A-Cat")).click();
    driver.findElement(By.id("catnips")).sendKeys("3000000000000000000000000000000000000");
    driver.findElement(By.xpath("//button[text()=\"Feed\"]")).click();
    {
      WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(50));
